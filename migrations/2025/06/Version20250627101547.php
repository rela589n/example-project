...
final class Version20250627101547 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE accounting_account_transactions 
                ADD CONSTRAINT FK_8A9C75AF9B6B5FBAA76ED395 
                    FOREIGN KEY (account_id, user_id) 
                        REFERENCES accounting_accounts (id, user_id) 
