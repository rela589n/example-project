...
namespace App\EmployeePortal\Blog\Post\_Features\GetMy\Port;

use App\EmployeePortal\Blog\Post\_Features\GetMy\MyPostDto;
...
final readonly class GetMyPostsQuery
{
    ...
    public function execute(PostCollection $postCollection): array
    {
        ...
        return array_map(MyPostDto::fromEntity(...), array_values($posts->toArray()));
    }
}
