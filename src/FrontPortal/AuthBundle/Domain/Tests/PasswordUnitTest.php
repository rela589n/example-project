...
final class PasswordUnitTest extends TestCase
{
    ...
    public function testPasswordMustBeAtLeast8CharactersLong(): void
    {
        ...
        Password::fromUserInput($this->validator, $this->passwordHasher, '1234567');
    }
    ...
    public function testPasswordMustNotBeLongerThan31CharactersLong(): void
    {
        ...
        Password::fromUserInput($this->validator, $this->passwordHasher, str_repeat('@', 32));
    }
    ...
    public function testPasswordMustNotBeWeak(string $weakPassword): void
    {
        ...
        Password::fromUserInput($this->validator, $this->passwordHasher, $weakPassword);
    }

    public function testValidPassword(): void
    {
        $password = Password::fromUserInput($this->validator, $this->passwordHasher, '58Ez%;7g_cQ\Gj');
