...
final class LazyLoadingProxyIntegrationTest extends KernelTestCase
{
    ...
    public function testNativeProxyFollowingGhostCanNotBeCreated(): void
    {
    ...
    public function testTwoLazyProxiesFollowingTheSameObject(): void
    {
    ...
    public function testProxyMethodsDoNotExposeThisOfObject(): void
    {
        $object = new SimpleProxiedObject(1, '2', '3');
    ...
    public function testNativeProxyOverGhostFollowingGhost(): void
    {
        ...
        /** @var SimpleProxiedObject $proxyToProxy */
        $proxyToProxy = $reflectionClass->newLazyProxy(fn () => $proxy);
